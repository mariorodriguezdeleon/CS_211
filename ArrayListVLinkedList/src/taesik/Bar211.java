...
// This program is to test Assignment 4.
...
public class Bar211 {
	 ...
	 final int W=950,H=830;//width and height of JFrame
	 private JFrame f; 
	 private JPanel p;
	 ...
	 Color colorBarLinkedList = new Color (0,21,79);
	  ...
	  String mainTitle ="ArrayList vs LinkedList: Which one is faster?"; 
	 ...
	 public Bar211(String yourName, int howManyTests) {  // constructor
		 ...
		 f=new JFrame("Assignment 4. ArrayList vs LinkedList. CS 211, Spring 2021"); 
		 f.setSize(W, H);
		 ...
		 lab0.setBounds(W/8,40,W-20,H/6);
